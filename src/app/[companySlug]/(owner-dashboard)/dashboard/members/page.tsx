...
export default function OrgMembersPage() {
  ...
  const { data: membersData, isLoading: membersLoading } =
    api.member.listWithStatus.useQuery(
              ...
              {inviteResult ? (
                <>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Share this code with {inviteResult.email} so they can
                      join.
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  <p className="text-xs text-muted-foreground">
                    They can also accept via the invite email. The code expires
                    in 7 days.
                  </p>
                  <DialogFooter>
                    <Button
                ...
                <>
                  ...
                  <DialogFooter>
                    ...
                    <Button
                      onClick={form.handleSubmit(onInvite)}
                      disabled={form.formState.isSubmitting}
                    >
                      {form.formState.isSubmitting
                        ? "Sending..."
          ...
          {members.length === 0 ? (
            ...
            <div>
              {members.map((member, idx) => (
                <div
                  key={member.id}
                  className={`flex items-center gap-3 px-4 py-3 ${idx < members.length - 1 ? "border-b border-border" : ""}`}
                >
                  <Avatar size="sm">
                    {member.user.image ? (
                      <AvatarImage
        ...
        <div>
          ...
          <div className="rounded-none border border-border">
            {pendingInvitations.map((inv, idx) => (
              <div
                key={inv.id}
                className={`flex items-center gap-3 px-4 py-3 ${idx < pendingInvitations.length - 1 ? "border-b border-border" : ""}`}
              >
