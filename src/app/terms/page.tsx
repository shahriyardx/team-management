...
export const metadata: Metadata = {
  ...
  description:
    "WeirdTeams terms of service — the rules for using our platform.",
}
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground">
            <div>
              ...
              <p>
                By accessing or using WeirdTeams ("the Platform"), you agree to
            ...
            <div>
              ...
              <p>
                WeirdTeams provides a team management platform that includes
                task management, knowledge base, OKR tracking, and member
                management features. We reserve the right to modify, suspend, or
                discontinue any aspect of the Platform at any time.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1.5">
                ...
                <li>
                  Upload malicious code or content that could harm the Platform
                  or other users
                </li>
            ...
            <div>
              ...
              <p>
                ...
                We claim no intellectual property rights over your data. The
                Platform itself, including its code, design, and branding, is
                owned by WeirdTeams.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                WeirdTeams shall not be liable for any indirect, incidental,
                special, consequential, or punitive damages arising out of or
                related to your use of the Platform, whether based on warranty,
            ...
            <div>
              ...
              <p>
                ...
                violation of these terms. You may terminate your account at any
                time through your account settings. Upon termination, your data
