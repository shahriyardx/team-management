...
export default function TeamKnowledgeDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!data?.item) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center gap-3 p-6">
        ...
        <Link href={`/dashboard/team/${teamId}/knowledge-base`}>
  ...
  return (
    <div className="flex-1 overflow-auto p-6">
      <div className="max-w-2xl">
        <Link
          href={`/dashboard/team/${teamId}/knowledge-base`}
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    ...
                    router.push(`/dashboard/team/${teamId}/knowledge-base`)
                  } catch {
                    setShowDelete(false)
                  }
                }}
