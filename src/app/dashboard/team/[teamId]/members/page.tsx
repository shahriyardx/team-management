            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                {team.leader?.user?.id === tm.user.id && (
                  <Badge variant="outline" className="text-[9px]">Leader</Badge>
                )}
                {tm.role === "leader" && team.leader?.user?.id !== tm.user.id && (
                  <Badge variant="secondary" className="text-[9px]">Co-leader</Badge>
                )}
              </div>
