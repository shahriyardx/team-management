...
export function InvitationEmail({
  ...
  inviterName = "John",
  role = "member",
  acceptUrl = "https://pulse.app/invitations/accept?id=123",
}: {
  ...
  return (
    <Html>
      <Head />
      <Preview>Join {organizationName} on Pulse</Preview>
      <Tailwind>
        <Body className="bg-[#fafafa] font-sans mx-auto my-auto py-8 px-4">
          <Container className="bg-white border border-[#e5e7eb] rounded-lg mx-auto p-8 max-w-[480px]">
            ...
            <Text className="text-xs text-[#999] m-0">&copy; 2026 Pulse</Text>
          </Container>
        </Body>
      </Tailwind>
    </Html>
